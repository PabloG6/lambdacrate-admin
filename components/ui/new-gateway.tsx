...
import { ChevronDown, Loader2, SquareChevronRight, XIcon } from "lucide-react";
import {
  Dialog,
  DialogDescription,
  DialogHeader,
...
export default function NewGateway({ onOpenChange }: Props) {
  ...
  const { mutateAsync, isPending } = trpc.gateway.create.useMutation();
    ...
    <div className="flex w-full flex-col h-screen max-h-screen bg-background">
      <Form {...form}>
        ...
        >
          ...
          >
            <div className="px-4 max-w-3xl mx-auto space-y-6 py-6">
              <div>
